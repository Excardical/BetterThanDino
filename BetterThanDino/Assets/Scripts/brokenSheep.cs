...
public class brokenSheep : MonoBehaviour
{
    // Health variables
    ...
    private void CheckForEnemy()
    {
        ...
        if (hits.Length > 0)
        {
            ...
            {
                allyState = AllyState.Attacking;
                attackCooldownTimer = attackCooldown;
                Attack();
            }
            else if (distanceToTarget > attackRange)
            {
                allyState = AllyState.Chasing;
            }
        }
        else
        {
